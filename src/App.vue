<template>
    <div id="app">
        ...
        <main>
            ...
            <div class="main-ani">
                <div class="main-ani_item" v-for="i in 51" :key="i"></div>
            </div>
...
<style lang="scss">
    ...
    .table{
        ...
        .table-cell{
            ...
            &:first-child{
                background:rgba(234,11,11,.8);
            }

            &.success{
                background:rgba(11,234,106,.6);
                &:first-child{
                    background:rgba(11,234,106,.8);
                }
            }
        }
        .cell-item{
