export default {
    ...
    j: 'Suggest Gas Price',
    k: 'Jackpot Size: ',
    l: 'Bet now for {reward}x LT reward',
    m: 'All Bets',
    n: 'My Bets',
    o: 'Time',
    p: 'Player',
    ...
    ao: 'Cumulative bet {num} ETH Bonus {precent}%',
    ap: 'When the balance in the user\'s wallet is insufficient, it can quickly recharge online through this entrance. The recharge website comes from a third-party payment platform, and has no cooperation with Limitless. The user knows the risk by default when recharging.<br><a href="">Understand, go ahead</a>',
